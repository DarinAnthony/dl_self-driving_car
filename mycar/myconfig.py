...
PWM_STEERING_THROTTLE = {
    "PWM_STEERING_PIN": "PIGPIO.BCM.12",   # PWM output pin for steering servo
    "PWM_STEERING_SCALE": 1.0,              # used to compensate for PWM frequency differents from 60hz; NOT for adjusting steering range
    "PWM_STEERING_INVERTED": False,         # True if hardware requires an inverted PWM pulse
    "PWM_THROTTLE_PIN": "PIGPIO.BCM.13",   # PWM output pin for ESC
    "PWM_THROTTLE_SCALE": 1.0,              # used to compensate for PWM frequence differences from 60hz; NOT for increasing/limiting speed
    "PWM_THROTTLE_INVERTED": False,         # True if hardware requires an inverted PWM pulse
    "STEERING_LEFT_PWM": 400,             # 1ms pulse width for full left
    "STEERING_RIGHT_PWM": 200,            # 2ms pulse width for full right
    "THROTTLE_FORWARD_PWM": 350,          # 2ms pulse width for full forward
    "THROTTLE_STOPPED_PWM": 300,          # 1.5ms pulse width for neutral
    "THROTTLE_REVERSE_PWM": 250           # 1ms pulse width for full reverse
}
...
SERVO_HBRIDGE_2PIN = {
    ...
    "PWM_STEERING_SCALE": 0.83333,        # used to compensate for PWM frequency differents from 60hz; NOT for adjusting steering range
    "PWM_STEERING_INVERTED": False,   # True if hardware requires an inverted PWM pulse
...
SERVO_HBRIDGE_3PIN = {
    ...
    "PWM_STEERING_PIN": "RPI_GPIO.BOARD.33",   # provides servo pulse to steering servo
    "PWM_STEERING_SCALE": 0.833,        # used to compensate for PWM frequency differents from 60hz; NOT for adjusting steering range
    "PWM_STEERING_INVERTED": False,   # True if hardware requires an inverted PWM pulse
    "STEERING_LEFT_PWM": 460,         # pwm value for full left steering (use `donkey calibrate` to measure value for your car)
    "STEERING_RIGHT_PWM": 290,        # pwm value for full right steering (use `donkey calibrate` to measure value for your car)
}
...
PIGPIO_STEERING_MID = 300         # Adjust this value if your car cannot run in a straight line
PIGPIO_MAX_FORWARD = 350          # Max throttle to go fowrward. The bigger the faster
PIGPIO_STOPPED_PWM = 300
PIGPIO_MAX_REVERSE = 250          # Max throttle to go reverse. The smaller the faster
...
COLOR_THRESHOLD_LOW  = (0, 50, 50)   # HSV dark blue
COLOR_THRESHOLD_HIGH = (50, 255, 255) # HSV light blue
...
THROTTLE_MAX = 0.58    # maximum throttle value the controller will produce
THROTTLE_MIN = 0.54   # minimum throttle value the controller will produce
